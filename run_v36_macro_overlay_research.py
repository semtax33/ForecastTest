...
from run_v353_grouped_component import _load_inputs


ROOT = Path(__file__).resolve().parent
DEFAULT_OUTPUT = ROOT / "output" / "v3_6_macro_overlay_research"
SNAPSHOT = ROOT / "data-lake" / "v3_6_macro_snapshot"
...
def main() -> int:
    ...
    if args.refresh_macro_data:
        refresh_macro_snapshot(
            SNAPSHOT, ROOT / "data-lake" / "energy_v3_3_eia_prices_daily.csv"
        )
