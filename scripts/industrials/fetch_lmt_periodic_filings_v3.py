...
CIK_PADDED = "0000936468"
CIK_ARCHIVE = "936468"
START_DATE = "2021-01-01"
CUTOFF_DATE = "2026-09-03"
FORMS = {"10-K", "10-Q"}
ROOT = PROJECT_ROOT / "data-lake/bronze/industrials/v3/sec/lmt"
...
def main() -> int:
    user_agent = os.environ.get(
        "SEC_USER_AGENT",
        "ForecastTest LMT aerospace portability research contact@example.com",
    )
    ...
    manifest = {
        "dataset": "LMT_PERIODIC_FILINGS_INDUSTRIALS_V3",
