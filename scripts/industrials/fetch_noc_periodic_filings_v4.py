...
CIK_PADDED = "0001133421"
CIK_ARCHIVE = "1133421"
START_DATE = "2021-01-01"
CUTOFF_DATE = "2026-09-03"
FORMS = {"10-K", "10-Q"}
ROOT = PROJECT_ROOT / "data-lake/bronze/industrials/v4/sec/noc"
...
def main() -> int:
    user_agent = os.environ.get(
        "SEC_USER_AGENT",
        "ForecastTest NOC aerospace portability research contact@example.com",
    )
    ...
    manifest = {
        "dataset": "NOC_PERIODIC_FILINGS_INDUSTRIALS_V4",
